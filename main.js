...
(function() {
  var BALLOON_OFFSET, CATEGORY, DEFAULT_ZOOM_LEVEL, DISTANCE, GroupedMarker, INIT_LATITUDE, INIT_LONGTITUDE, Item, Map, USER_ID, ZOOM_LEVEL, api_url, load_address, load_mmc_location, read_user_follow_items, resizeContentHeight, search_item;

  $(document).ready(function() {
    var category, distance, elm, key;
    resizeContentHeight();
  ...
  Map = (function() {
    ...
    Map.prototype.update = function(category, word, distance) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        this.gmap.setZoom(ZOOM_LEVEL[distance]);
